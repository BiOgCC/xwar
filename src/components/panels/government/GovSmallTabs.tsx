  ...
  return (
    <>
      ...
      <div className="gov-section gov-section--highlight">
        ...
        <div className="gov-stat-row"><span className="gov-stat-row__label" style={{ display: 'flex', alignItems: 'center', gap: '4px' }}><ResourceIcon resourceKey="oil" size={12} /> Company Oil Upkeep (20%)</span><span className="gov-stat-row__value" style={{ color: '#a855f7' }}>{fund.oil.toLocaleString()} oil</span></div>
