...
export type PanelType = 'profile' | 'combat' | 'market' | 'companies' | 'government' | 'chat' | 'resources' | 'cyberwarfare' | 'missions' | 'prestige' | 'military' | 'foreign_country' | 'casino' | 'bounty' | 'stocks' | null
