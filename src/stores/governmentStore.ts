...
export type LawType = 'declare_war' | 'propose_peace' | 'impeach_president' | 'tax_change'
...
export const useGovernmentStore = create<GovernmentState>((set, get) => ({
  governments: {
    'US': { countryId: 'US', president: 'Commander_X', congress: ['Commander_X', 'AI_Rep_2', 'AI_Rep_3', 'AI_Rep_4', 'AI_Rep_5'], candidates: [], taxRate: 10 },
    'RU': { countryId: 'RU', president: 'AI_Commander_Putin', congress: ['AI_Rep_1', 'AI_Rep_2', 'AI_Rep_3', 'AI_Rep_4', 'AI_Rep_5'], candidates: [], taxRate: 10 },
    'CN': { countryId: 'CN', president: 'AI_Commander_Xi', congress: ['AI_Rep_1', 'AI_Rep_2', 'AI_Rep_3', 'AI_Rep_4', 'AI_Rep_5'], candidates: [], taxRate: 10 },
    'DE': { countryId: 'DE', president: 'AI_Commander_Scholz', congress: ['AI_Rep_1', 'AI_Rep_2', 'AI_Rep_3', 'AI_Rep_4', 'AI_Rep_5'], candidates: [], taxRate: 10 },
    'BR': { countryId: 'BR', president: 'AI_Commander_Lula', congress: ['AI_Rep_1', 'AI_Rep_2', 'AI_Rep_3', 'AI_Rep_4', 'AI_Rep_5'], candidates: [], taxRate: 10 },
    'IN': { countryId: 'IN', president: 'AI_Commander_Modi', congress: ['AI_Rep_1', 'AI_Rep_2', 'AI_Rep_3', 'AI_Rep_4', 'AI_Rep_5'], candidates: [], taxRate: 10 },
    'NG': { countryId: 'NG', president: 'AI_Commander_Tinubu', congress: ['AI_Rep_1', 'AI_Rep_2', 'AI_Rep_3', 'AI_Rep_4', 'AI_Rep_5'], candidates: [], taxRate: 10 },
    'JP': { countryId: 'JP', president: 'AI_Commander_Kishida', congress: ['AI_Rep_1', 'AI_Rep_2', 'AI_Rep_3', 'AI_Rep_4', 'AI_Rep_5'], candidates: [], taxRate: 10 },
    'GB': { countryId: 'GB', president: 'AI_Commander_Sunak', congress: ['AI_Rep_1', 'AI_Rep_2', 'AI_Rep_3', 'AI_Rep_4', 'AI_Rep_5'], candidates: [], taxRate: 10 },
    'TR': { countryId: 'TR', president: 'AI_Commander_Erdogan', congress: ['AI_Rep_1', 'AI_Rep_2', 'AI_Rep_3', 'AI_Rep_4', 'AI_Rep_5'], candidates: [], taxRate: 10 },
    'CA': { countryId: 'CA', president: 'AI_Commander_Trudeau', congress: ['AI_Rep_1', 'AI_Rep_2', 'AI_Rep_3', 'AI_Rep_4', 'AI_Rep_5'], candidates: [], taxRate: 10 },
    'MX': { countryId: 'MX', president: 'AI_Commander_Sheinbaum', congress: ['AI_Rep_1', 'AI_Rep_2', 'AI_Rep_3', 'AI_Rep_4', 'AI_Rep_5'], candidates: [], taxRate: 10 },
    'CU': { countryId: 'CU', president: 'AI_Commander_DiazCanel', congress: ['AI_Rep_1', 'AI_Rep_2', 'AI_Rep_3', 'AI_Rep_4', 'AI_Rep_5'], candidates: [], taxRate: 10 },
    'BS': { countryId: 'BS', president: 'AI_Commander_Davis', congress: ['AI_Rep_1', 'AI_Rep_2', 'AI_Rep_3', 'AI_Rep_4', 'AI_Rep_5'], candidates: [], taxRate: 10 },
  },
  laws: {},
